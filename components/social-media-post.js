...
const SocialMediaPost = ({ post }) => {
  ...
  return data ? (
    ...
    >
      {data.provider_name === "Twitter" && <Twitter className="-mt-2 sm:-mt-6 -mr-2 sm:-mr-6 mb-2 ml-auto text-gray-400"/>}
      {data.provider_name === "Facebook" && <Facebook className="-mt-2 sm:-mt-6 -mr-2 sm:-mr-6 mb-2 ml-auto text-gray-400"/>}
