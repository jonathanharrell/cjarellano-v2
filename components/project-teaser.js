...
function ProjectTeaser({ project }) {
  return (
    <a href={`/project/${project.slug}`} className="block relative overflow-hidden rounded-lg shadow hover:shadow-xl transform lg:hover:scale-110 transition-all ease-out duration-300 group" style={{ padding: "35% 0" }}>
